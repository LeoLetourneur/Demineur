...
/**
 * Classe de param�tres du jeu.
 * Classe repr�sentant la vue et le controleur du menu param�tres.
 * 
...
public class ParametreVue extends JDialog implements ItemListener, ActionListener {
	...
	*/
	public ParametreVue(JeuModele p_modele) {
		...
		rdbtnPersonnalise = new JRadioButton("Personnalis�e");
		...
		JLabel labelAttention = new JLabel("Attention votre partie sera r�initialis�e");
		...
		if(modele instanceof JeuModeleDJ) {
			chckbxUseQuestionMark.setEnabled(false);
			chckbxUseTime.setEnabled(false);
		}
	}
	
	/** 
	* Rendre modifiable les param�tres de la grille en fonction du checkbox
	*
	*/
